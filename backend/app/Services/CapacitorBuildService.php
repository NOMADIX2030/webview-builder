...
class CapacitorBuildService
{
    ...
    /**
     * Android 공식 아이콘 규격 적용 (developer.android.com)
     * - Legacy: mdpi 48, hdpi 72, xhdpi 96, xxhdpi 144, xxxhdpi 192 px
     * - Adaptive foreground (108dp): mdpi 108, hdpi 162, xhdpi 216, xxhdpi 324, xxxhdpi 432 px
     */
    private function copyIcons(string $projectPath, Build $build): void
    {
        ...
        // drawable-v24 vector 제거 → mipmap PNG가 adaptive icon foreground로 사용되도록
